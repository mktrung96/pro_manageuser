			...
			<table border="0" cellpadding="4" cellspacing="0" width="300px">
				<tr>
					...
					<td><input class="btn" type="button"
						onclick="javascript:window.location.href='EditUserInfo.do?key=${key}&userID=${userInfo.userID}'"
						value="編集" /></td>
					<td><input class="btn" type="button"
						onclick="javascript:window.location.href='ChangePassword.do?type=changePassword&userID=${userInfo.userID}'"
						value="Change Password" /></td>
					<td><input class="btn" type="button"
						onclick="alertDelete(${userInfo.userID})" value="削除" /></td>
